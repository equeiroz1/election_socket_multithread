        ...
        try:
            ...
            if len(msg_split) > 1:
                ...
                if destino == my_name.get():
                    ...
                    msg_list.insert(tkinter.END, "Voto: " + msg_split[2])
...
l_voto = tkinter.Label(janela, text="       Voto:", font="Verdana 16 bold", width=11, height=1, bg="#DCDCDC")
...
e_voto = tkinter.Entry(janela, font="verdana 12 bold", fg="#2F4F4F", textvariable=my_vote)
e_voto.bind("<Return>", )
...
l_voto.grid(row=4, column=1, sticky="w")
